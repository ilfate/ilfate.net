...
I will start with <span class="label label-default label-stars" data-value="99">PHP</span> because it is my primary skill. 
I have started my <span class="label label-default label-stars" data-value="99">PHP</span> learning when i was a student.
Also with it goes <span class="label label-default label-stars" data-value="70">JavaScript</span> and <span class="label label-default label-stars" data-value="60">CSS</span> skills.
One time i spend a summer learning <span class="label label-default label-stars" data-value="40">Java</span> well i still know it!<br>
Also i must mention my database skills. I started with <span class="label label-default label-stars" data-value="80">MySql</span>, then got some expireanse in <span class="label label-default label-stars" data-value="50">Oracle</span> after it a come back to <span class="label label-default label-stars" data-value="80">MySql</span>.<br>
In my work i used some tehnogies like <span class="label label-default label-stars" data-value="95">Memcache</span>, <span class="label label-default label-stars" data-value="75">PhpUnit</span> and <span class="label label-default label-stars" data-value="55">HandlerSocket</span><br>

<br>
<br>
<br>
<span class="label label-default label-stars" data-value="10">1234567891011</span><br>
<span class="label label-default label-stars" data-value="20">123456789101112</span><br>
<span class="label label-default label-stars" data-value="30">12345678910111213</span><br>
<span class="label label-default label-stars" data-value="40">1234567891011121314</span><br>
<span class="label label-default label-stars" data-value="50">123456789101112131415</span><br>
<span class="label label-default label-stars" data-value="60">12345678910111213141516</span><br>
<span class="label label-default label-stars" data-value="70">1234567891011121314151617</span><br>
<span class="label label-default label-stars" data-value="80">123456789101112131415161718</span><br>
<span class="label label-default label-stars" data-value="90">12345678910111213141516171819</span><br>
<span class="label label-default label-stars" data-value="100">1234567891011121314151617181920</span><br>
*/ ?>
